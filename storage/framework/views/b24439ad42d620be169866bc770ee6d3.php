        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex justify-between items-centers mb-5 text-gray-500">
                        <a href="/posts?categories/<?php echo e($post->category->slug); ?>">
                    ...
                    <div class="flex justify-between items-center">
                        <a href="/posts?author=<?php echo e($post->author->username); ?>">
                            <div class="flex items-center space-x-3">
                                <img class="w-6 h-6 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="<?php echo e($post->author->name); ?>" />
                        ...
                        <a href="/posts/<?php echo e($post->slug); ?>" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                            Read more
...
<?php endif; ?>
<?php /**PATH C:\Users\aryan\Herd\laravel11\resources\views/posts.blade.php ENDPATH**/ ?>