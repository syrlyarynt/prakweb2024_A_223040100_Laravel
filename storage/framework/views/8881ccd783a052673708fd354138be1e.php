            ...
            <header class="mb-4 lg:mb-6 not-format">
                ...
                <address class="flex items-center my-6 not-italic">
                    <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                        ...
                        <div>
                            <a href="/post?author=<?php echo e($post->author->username); ?>" rel="author" class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($post->author->name); ?></a>
...
<?php endif; ?><?php /**PATH C:\Users\aryan\Herd\laravel11\resources\views/post.blade.php ENDPATH**/ ?>